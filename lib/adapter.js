...
module.exports = (function() {
    ...
    var adapter = {
        ...
        describe: function(connection, collection, cb) {
            log('DESCRIBE ' + connection + ' ' + collection);
            // log('DESCRIBE', {
            //     connection: connection,
        ...
        define: function(connection, collection, definition, cb) {
            log('DEFINE ' + connection + ' ' + collection);
        ...
        drop: function(connection, collection, relations, cb) {
            log(('DROP ' + connection + ' ' + collection).red.inverse);
            // log('DROP', {
            //     connection: connection,
            //     collection: collection,
            //     relations: relations
        ...
        find: function(connection, collection, options, cb) {
            log('FIND ' + connection + ' ' + collection);
        ...
        findAndCount: function(connection, collection, options, cb) {
            log('FIND AND COUNT ' + connection + ' ' + collection);
        ...
        count: function(connection, collection, options, cb) {
            log('COUNT ' + connection + ' ' + collection);
        ...
        create: function(connection, collection, values, cb) {
            log('CREATE ' + connection + ' ' + collection);
        ...
        destroy: function(connection, collection, options, cb) {
            log('DESTROY ' + connection + ' ' + collection);
        ...
        query: function(connection, collection, options, cb) {
            log('QUERY ' + connection + ' ' + collection);
        ...
        rawQuery: function(connection, collection, options, cb) {
            log('RAW QUERY ' + connection + ' ' + collection);
    ...
    function grabConnectionNew(connection, collection) {
        if (this.defaults.single == true) {
            return connections[connection];
        } else {
            return connections[connection];
