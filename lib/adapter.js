...
module.exports = (function() {
    ...
    var adapter = {
        ...
        suggest: function(connection, collection, options, cb) {
            this.log('suggest ' + connection + ' ' + collection);
        ...
        browse: function(connection, collection, options, cb) {
            this.log('browse ' + connection + ' ' + collection);
            grabConnection(connection).browse(collection, options, function(err, data) {
                if (err) {
