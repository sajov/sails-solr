...
Collection.prototype.find = function(connection, collection, options, cb) {
    ...
    log('FIND query'.magenta.red, query);
...
Collection.prototype._prepareDocuments = function(connection, collection, values) {
    ...
    var jsonFields = [];
    // console.log('_prepareDocuments ####??', connection);
    // console.log('_prepareDocuments ####??', collection);
    // console.log('_prepareDocuments ####??', self.collections[collection].definition);
